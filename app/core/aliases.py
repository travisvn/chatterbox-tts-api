...
ENDPOINT_ALIASES: Dict[str, List[str]] = {
    "/voices/default": ["/v1/voices/default"],
    ...
    "/audio/voices": ["/v1/audio/voices", "/voice-library", "/voice_library"],
    "/audio/voices/default": ["/v1/audio/voices/default", "/default-voice"],
    "/audio/voices/{voice_name}": ["/v1/audio/voices/{voice_name}"],
    "/voices/{voice_name}": ["/v1/voices/{voice_name}"],
    "/audio/voices/{voice_name}/download": ["/v1/audio/voices/{voice_name}/download"],
    "/voices/{voice_name}/download": ["/v1/voices/{voice_name}/download"],
    "/audio/voices/{voice_name}/aliases": ["/v1/audio/voices/{voice_name}/aliases"],
    "/audio/voices/{voice_name}/aliases/{alias}": ["/v1/audio/voices/{voice_name}/aliases/{alias}"],
    "/voices/all-names": ["/v1/voices/all-names"],
    "/voices/cleanup": ["/v1/voices/cleanup"],
    "/health": ["/v1/health", "/status"],
    "/audio/models": ["/v1/audio/models"],
    "/load_model": ["/v1/load_model"],
    "/unload_model": ["/v1/unload_model"],
    "/config": ["/v1/config"],
